...
def test_login():
   ...
   #          stdout = output, stderr = error, shell = False)
    p = subprocess.Popen(['ssh','root@127.0.0.1'], stdin = input, 
             stdout = output, stderr = error, shell = False)
    p.stdin = input
    #p.stdin.write('fabregas19901218\n')
    #time.sleep(20)
    p.stdin.write('ls\n')
    login_input = open('/dev/pts/4', 'w+')
    login_input.write('ls\n')
    #p.communicate('fabregas19901218\n');
    #p.stdin.write('fabregas19901218\n')
    #p.stdin.write('help\n')
    #p.stdin.write('l\n')
    #p.stdin.write('quit\n')
    ...
    #print p.stdout.read()
    #input.write('help\n\n')
    #sys.stdout.write('fabregas19901218')
    #.stdin.write('fabregas19901218\n')
    #input.write('fabregas19901218')
    #time.sleep(100)
    p.wait()
    #p.stdin.write('help\n')
